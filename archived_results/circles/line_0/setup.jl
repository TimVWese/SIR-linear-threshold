...
dynamics(epi::AbstractGraph) = LuMV_bi(epi; inf_A=true)
mmca_dynamics(epi::AbstractGraph) = mmca.sir(epi; inf_A=true)

dynamics(exp) = dynamics(read_from_mtx("graph_data/epi_1.mtx"))
small_dynamics(exp) = dynamics(read_from_mtx("graph_data/epi_1.mtx"))
mmca_dynamics(exp) = mmca_dynamics(read_from_mtx("graph_data/epi_1.mtx"))
