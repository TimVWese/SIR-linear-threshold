...
multiplex = false
#network_epi() = watts_strogatz(n^2, 4, 0.1)
network_epi() = SF_configuration_model(n^2, 2.5; min_d=3)
#network_epi_small() = watts_strogatz(n_small^2, 4, 0.1)
network_epi_small() = SF_configuration_model(n_small^2, 2.5; min_d=3)
