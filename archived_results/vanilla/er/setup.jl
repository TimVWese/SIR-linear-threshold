...
multiplex = false
network_epi() = erdos_renyi(n^2, 4/n^2)
network_opi() = nothing # erdos_renyi(n^2, 4/n^2)
network_epi_small() = erdos_renyi(n_small^2, 4/n_small^2)
network_opi_small() = nothing # erdos_renyi(n_small^2, 4/n_small^2)
